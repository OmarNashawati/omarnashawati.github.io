        ...
        <div id="details">
            ...
            <div id="colors_div">
                ...
                <div id="colors_options_div">
                    ${
                        selected_product.colors.map(id => {
                            if(id != selected_product.id){
                                const option = products.find(p => p.id == id) 
                                return (`
                                    <a href="product.html?id=${option.id}">
                                        <img src="../products_Media/${option.imgURL[0]}" alt="" srcset="">
                                    </a>
                                `)
                            }
                        }).join('')

...
const tag = new URLSearchParams(params).get('tag')

console.log(tag);
const title_section = document.getElementById('title_section')
title_section.innerHTML = `<h2>${tag}</h2>`


const produts_section = document.getElementById('produts_section')
...
produts_section.innerHTML = cards